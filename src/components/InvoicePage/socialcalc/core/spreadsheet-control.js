...
*/
  ...
  SocialCalc.InitializeSpreadsheetControl = function (
    ...
    spreadsheet.formulabarDiv.innerHTML =
      '<input type="text" lang="en-US" autocorrect="off" autocomplete="off" spellcheck="false" autocapitalize="off" inputmode="text" size="20" value="" disabled="true">';
...
*********/
  ...
  SocialCalc.Callbacks.ToggleCell = function (cellname) {
    ...
    if (!cellinner) return false;

    var checked =
      cellinner.innerHTML.indexOf("checkmark") !== -1 ||
      (cell && String(cell.datavalue || "").indexOf("checkmark") !== -1);
