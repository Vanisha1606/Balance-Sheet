   ...
   */
    ...
    SocialCalc.ProcessEditorMouseDown = function (e) {
        ...
        var tcConstraint =
            ...
            SocialCalc.EditableCells.constraints[sheetname + "!" + result.coord];
        if (
            tcConstraint &&
            tcConstraint[0] === "tc" &&
            SocialCalc.Callbacks &&
            SocialCalc.Callbacks.ToggleCell
        ) {
    ...
    SocialCalc.InputBoxDisplayCellContents = function (inputbox, coord) {
        ...
        if (text.indexOf("\n") != -1) {
            ...
            // Always use the React cell editor modal — never show native overlay input
            inputbox.element.disabled = true;
            inputbox.element.style.display = "none";
            SocialCalc.ToggleInputLineButtons(false);
